...
export const vacanciesService = {
  ...
  async getFilterOptions(): Promise<FilterMetadataPayload> {
    try {
      ...
      throw new Error("Failed to fetch vacancies filters!")
    }
  },
  ...
  async getAnalyticsByCategory(
    ...
    try {
      ...
      return data;
        ...
        throw new Error("Failed to fetch category's analytics for the main dashboard!")
    //   return (
  ...
  async getSummaryMetrics(): Promise<DashboardDataPayload> {
    try {
      ...
      return data;
        ...
        throw new Error("Failed to fetch analytics for the main dashboard!")
